...
pub fn resolve_paths() -> Result<MoonPaths> {
    ...
    let moon_home = env_or_default_path("MOON_HOME", home.join(".lilac_metaflora"));
    ...
    let logs_dir = env_or_default_path("MOON_LOGS_DIR", moon_home.join("skills/moon-system/logs"));
